 ...
 *       &lt;sequence>
 *         &lt;element ref="{}ligne-produit" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "lignes-produit")
public class LignesProduit {

    @XmlElement(name = "ligne-produit", required = true)
    protected List<LigneProduit> ligneProduit;
    ...
    public List<LigneProduit> getLigneProduit() {
        if (ligneProduit == null) {
            ligneProduit = new ArrayList<LigneProduit>();
        }
